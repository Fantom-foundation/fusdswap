...
import { useDisconnect, useWeb3ModalAccount, useWeb3ModalProvider } from '@web3modal/ethers5/vue';
...
export class Web3ModalWallet extends Web3Wallet {
    ...
    #bindEvents() {
        ...
        this.#bindedEvents.unwatchIsConnected = watch(isConnected, async (isConnected, isConnectedOld) => {
            if (isConnected) {
                this.activate();
            }
